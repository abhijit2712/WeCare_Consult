...
define('PAYTM_MERCHANT_KEY', '@U@qbGB_FQp6YVt3'); //Change this constant's value with Merchant key received from Paytm.
define('PAYTM_MERCHANT_MID', 'eCYDQP98239196203322'); //Change this constant's value with MID (Merchant ID) received from Paytm.
